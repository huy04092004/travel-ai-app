...
const ContactUsScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Gửi dữ liệu tới n8n webhook mới
    try {
      await fetch('https://6853-2001-ee0-4b46-6fe0-49ad-9e9e-1df5-bb8b.ngrok-free.app/webhook/traloitinnhan', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ name, email, message }),
      });
    } catch (err) {
      // Có thể log lỗi hoặc bỏ qua, vì đây chỉ là gửi mail cảm ơn
    }
        ...
        <ScrollView className="px-6">
          ...
          <View className="bg-white rounded-xl p-6 mb-10 shadow-sm">
            ...
            <View className="flex-row items-center mb-4">
              ...
              <Text className="ml-3 text-base">thinhnh.22ite@vku.udn.vn</Text>
            </View>
