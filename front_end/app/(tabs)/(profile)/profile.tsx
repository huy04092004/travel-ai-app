    ...
    <SafeAreaView className='bg-white flex-1 py-4 px-5 mb-10'>
      <ScrollView >
        ...
        <View className='mt-4 '>
          ...
          <TouchableOpacity
            className='flex-row border-b-2 border-b-[rgba(0,0,0,0.1)] py-7 items-center'
            onPress={() => { router.push("/(tabs)/(profile)/my_itineraries"); }}
          >
            <MaterialIcons className='px-3' name='event-note' size={28} color="#4086D5" />
            <Text className='text-xl px-2 '>Các lịch trình của bạn</Text>
            <MaterialIcons className='ml-auto' name='keyboard-arrow-right' size={30} color="#4086D5" />
          </TouchableOpacity>
        </View>
