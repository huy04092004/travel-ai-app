...
const categories = [
    ...
    { name: "Ẩm thực", icon: "restaurant-outline", apiValue: "food" },
...
export default function LocationsScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white mb-10">
            ...
            {/* Header */}
            <View className="pt-12 pb-6 px-6 bg-white flex-row justify-between items-center">
                <View>
                ...
                <TouchableOpacity onPress={() => router.push("/(tabs)/(locations)/favorite_locations")}
